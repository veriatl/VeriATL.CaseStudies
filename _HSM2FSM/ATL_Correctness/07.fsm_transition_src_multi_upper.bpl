procedure fsm_transition_src_multi_upper()
...
// post5b: fsm_transition_src_multi_upper
ensures (forall t: ref::
	...
	(forall st1,st2: ref:: 
		...
		read($tarHeap,t,FSM$Transition.source) == st1 &&
		read($tarHeap,t,FSM$Transition.source) == st2
			==>
		st1 == st2));
{

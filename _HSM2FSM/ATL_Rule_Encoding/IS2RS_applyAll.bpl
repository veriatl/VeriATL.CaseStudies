procedure IS2RS_applyAllTest() returns();
...
implementation IS2RS_applyAllTest () returns ()
{
	var $i : int;
	var link : ref;
	var links: Seq ref;
	
	links := NTransientLinkSet#getLinksByRule($linkHeap, _IS2RS);
	assume IS2RS_links($srcHeap,$linkHeap,$tarHeap,links);
